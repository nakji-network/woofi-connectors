...
// ExternalSwap0 is a paid mutator transaction binding the contract method 0xea71ee84.
//
...
func (_WooRouterV2 *WooRouterV2Transactor) ExternalSwap0(opts *bind.TransactOpts, approveTarget common.Address, swapTarget common.Address, fromToken common.Address, toToken common.Address, fromAmount *big.Int, to common.Address, data []byte) (*types.Transaction, error) {
	return _WooRouterV2.contract.Transact(opts, "externalSwap0", approveTarget, swapTarget, fromToken, toToken, fromAmount, to, data)
}

// ExternalSwap0 is a paid mutator transaction binding the contract method 0xea71ee84.
//
// Solidity: function externalSwap(address approveTarget, address swapTarget, address fromToken, address toToken, uint256 fromAmount, address to, bytes data) payable returns()
func (_WooRouterV2 *WooRouterV2Session) ExternalSwap0(approveTarget common.Address, swapTarget common.Address, fromToken common.Address, toToken common.Address, fromAmount *big.Int, to common.Address, data []byte) (*types.Transaction, error) {
	return _WooRouterV2.Contract.ExternalSwap0(&_WooRouterV2.TransactOpts, approveTarget, swapTarget, fromToken, toToken, fromAmount, to, data)
}

// ExternalSwap0 is a paid mutator transaction binding the contract method 0xea71ee84.
//
// Solidity: function externalSwap(address approveTarget, address swapTarget, address fromToken, address toToken, uint256 fromAmount, address to, bytes data) payable returns()
func (_WooRouterV2 *WooRouterV2TransactorSession) ExternalSwap0(approveTarget common.Address, swapTarget common.Address, fromToken common.Address, toToken common.Address, fromAmount *big.Int, to common.Address, data []byte) (*types.Transaction, error) {
	return _WooRouterV2.Contract.ExternalSwap0(&_WooRouterV2.TransactOpts, approveTarget, swapTarget, fromToken, toToken, fromAmount, to, data)
}
