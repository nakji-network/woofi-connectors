...
func (_WooRouterV3 *WooRouterV3Caller) TryQuerySwap(opts *bind.CallOpts, fromToken common.Address, toToken common.Address, fromAmount *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _WooRouterV3.contract.Call(opts, &out, "tryQuerySwap", fromToken, toToken, fromAmount)
...
//
// Solidity: function tryQuerySwap(address fromToken, address toToken, uint256 fromAmount) view returns(uint256 toAmount)
func (_WooRouterV3 *WooRouterV3Session) TryQuerySwap(fromToken common.Address, toToken common.Address, fromAmount *big.Int) (*big.Int, error) {
	return _WooRouterV3.Contract.TryQuerySwap(&_WooRouterV3.CallOpts, fromToken, toToken, fromAmount)
}

// TryQuerySwap is a free data retrieval call binding the contract method 0x9d82e123.
//
// Solidity: function tryQuerySwap(address fromToken, address toToken, uint256 fromAmount) view returns(uint256 toAmount)
func (_WooRouterV3 *WooRouterV3CallerSession) TryQuerySwap(fromToken common.Address, toToken common.Address, fromAmount *big.Int) (*big.Int, error) {
	return _WooRouterV3.Contract.TryQuerySwap(&_WooRouterV3.CallOpts, fromToken, toToken, fromAmount)
}
...
func (_WooRouterV3 *WooRouterV3Transactor) InCaseTokenGotStuck(opts *bind.TransactOpts, stuckToken common.Address) (*types.Transaction, error) {
	return _WooRouterV3.contract.Transact(opts, "inCaseTokenGotStuck", stuckToken)
}

// InCaseTokenGotStuck is a paid mutator transaction binding the contract method 0xe1a4e72a.
//
// Solidity: function inCaseTokenGotStuck(address stuckToken) returns()
func (_WooRouterV3 *WooRouterV3Session) InCaseTokenGotStuck(stuckToken common.Address) (*types.Transaction, error) {
	return _WooRouterV3.Contract.InCaseTokenGotStuck(&_WooRouterV3.TransactOpts, stuckToken)
}

// InCaseTokenGotStuck is a paid mutator transaction binding the contract method 0xe1a4e72a.
//
// Solidity: function inCaseTokenGotStuck(address stuckToken) returns()
func (_WooRouterV3 *WooRouterV3TransactorSession) InCaseTokenGotStuck(stuckToken common.Address) (*types.Transaction, error) {
	return _WooRouterV3.Contract.InCaseTokenGotStuck(&_WooRouterV3.TransactOpts, stuckToken)
}
